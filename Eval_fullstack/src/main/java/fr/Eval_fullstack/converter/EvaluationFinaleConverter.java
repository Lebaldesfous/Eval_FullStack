...
public class EvaluationFinaleConverter {
    ...
    public static EvaluationFinaleDto entityEvaluationFinaleToDto(EvaluationFinaleEntity entityEvaluationFinale){
        ...
        return EvaluationFinaleDto.builder().id(entityEvaluationFinale.getId()).note(entityEvaluationFinale.getNote()).nom(entityEvaluationFinale.getNom()).nom(entityEvaluationFinale.getNom()).description(entityEvaluationFinale.getDescription()).build();
    }
